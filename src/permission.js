...
import StorageUtil, { goodStorage } from "@/utils/storage";
...
const allowList = [LOGIN_PATH] // no redirect allowList
      ...
      store
        ...
        .then(res => {
          ...
          store.dispatch('GenerateRoutes', { roles }).then(() => {
            ...
            console.log(store.getters.addRouters,'路由-router.beforeEach')
